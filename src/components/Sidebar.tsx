...
export const Sidebar = ({
  ...
  // Manejar Escape para cerrar el modal de configuración
  useEffect(() => {
      ...
      >
        ...
        <div className="p-4">
          <button
            ...
            className="w-full flex items-center gap-2 text-sm font-medium text-gray-700 px-3 py-2 rounded-lg transition-colors duration-150"
          >
